...
//           } else {
//             setData(null);
//          Alert.alert('No data found for this Customer ID.');
//           }
//         })
//         .catch(err => {
//           console.error(err);
...
//     } else {
//    Alert.alert('Please ensure Customer ID and Category ID are available');
//     }
//   };
...
//          Alert.alert('Content updated successfully');
//             onClose();
//           } else {
...
//         .catch(err => {
//           console.error(err);
//        Alert.alert('Update failed due to network error');
//         })
//         .finally(() => setLoading(false));
//     } else {
//      Alert.alert('Missing customer ID, category ID, or content data');
//     }
//   };
